...
export default function Hero() {
  ...
  return (
    <section className="child flex-1 grid-cols-2 md:grid overflow-x-hidden relative">
      <div className="absolute h-full w-full bg-mosque-shilouette bg-no-repeat bg-bottom opacity-5"></div>
        ...
        <div className="flex flex-col justify-center align-between space-y-8 overflow-y-hidden">
          <p>
            {saying.author} :
          </p>
